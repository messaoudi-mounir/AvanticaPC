...
public class ArrayOfBoolean extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"ArrayOfBoolean\",\"namespace\":\"Petrolink.Datatypes\",\"fields\":[{\"name\":\"values\",\"type\":{\"type\":\"array\",\"items\":\"boolean\"}}],\"fullName\":\"Petrolink.Datatypes.ArrayOfBoolean\",\"depends\":[]}");
  ...
  public static Petrolink.Datatypes.ArrayOfBoolean.Builder newBuilder() {
    return new Petrolink.Datatypes.ArrayOfBoolean.Builder();
  }
  
  /** Creates a new ArrayOfBoolean RecordBuilder by copying an existing Builder */
  public static Petrolink.Datatypes.ArrayOfBoolean.Builder newBuilder(Petrolink.Datatypes.ArrayOfBoolean.Builder other) {
    return new Petrolink.Datatypes.ArrayOfBoolean.Builder(other);
  }
  
  /** Creates a new ArrayOfBoolean RecordBuilder by copying an existing ArrayOfBoolean instance */
  public static Petrolink.Datatypes.ArrayOfBoolean.Builder newBuilder(Petrolink.Datatypes.ArrayOfBoolean other) {
    return new Petrolink.Datatypes.ArrayOfBoolean.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<ArrayOfBoolean>
    ...
    private Builder() {
      super(Petrolink.Datatypes.ArrayOfBoolean.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(Petrolink.Datatypes.ArrayOfBoolean.Builder other) {
      super(other);
    ...
    private Builder(Petrolink.Datatypes.ArrayOfBoolean other) {
            super(Petrolink.Datatypes.ArrayOfBoolean.SCHEMA$);
      if (isValidValue(fields()[0], other.values)) {
        this.values = data().deepCopy(fields()[0].schema(), other.values);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'values' field */
    public Petrolink.Datatypes.ArrayOfBoolean.Builder setValues(java.util.List<java.lang.Boolean> value) {
    ...
    public Petrolink.Datatypes.ArrayOfBoolean.Builder clearValues() {
      values = null;
