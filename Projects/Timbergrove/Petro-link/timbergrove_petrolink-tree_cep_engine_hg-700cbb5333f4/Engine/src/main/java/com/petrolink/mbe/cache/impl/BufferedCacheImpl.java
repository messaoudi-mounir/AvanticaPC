...
/**
 * Buffered Cache implementation for use on Global Historical or Preloaded Channel Caches
 * @author paul
 *
 */
public class BufferedCacheImpl implements GlobalCache {
	...
	public WellCache getOrCreateWell(UUID uuid) {
		...
		if (well == null) {
			well = new BufferedWellCacheImpl(this, uuid);
