 ...
 * @author aristo
 */
public final class WellCacheImpl extends LKVCacheResourceImpl implements WellCache {
	 ...
	 * @param uuid 
	 */
	public WellCacheImpl(LKVCacheImpl cache, UUID uuid) {
		super(cache, uuid);
	}
	...
	public ChannelCache getOrCreateChannel(UUID id) {
		...
		if (c == null) {
			...
			// value returned.
			c = new LKVChannelCacheImpl(getCache(), this, id);
