...
public class EmployeeCensusPage extends NavigationPage{
	...
	@FindBy (xpath="//select[@name = 'smoker']")
    public WebElement SmokerCombo;
	...
	public void fillBirthDate(String month, String day, String year){
		...
		driver.findElement(By.xpath("//select[@name = 'smoker']")).click();
			SmokerCombo.click ();
			
		wait.until(ExpectedConditions.visibilityOf(SmokerCombo));
		Select select = new Select(SmokerCombo);
	...
	public void fillEmployeeInformation(String firstName, String lastName, String month, String day, String year, String gender){
