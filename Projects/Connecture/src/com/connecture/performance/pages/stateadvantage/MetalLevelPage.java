...
public class MetalLevelPage extends BasePage{

	public MetalLevelPage(WebDriver driver) {
		super(driver);
	}

	public static MetalLevelPage getPage(WebDriver driver, Logger logHandler) {
		MetalLevelPage  page = PageFactory.initElements(driver, MetalLevelPage.class);
